...
public class CharacterAction {
    ...
    public Player ChooseEnemy( ChangeTexts changeTexts) {
        ...
        changeTexts.getEnemyPicture().setIcon(enemyy.getPicture());
        changeTexts.getEnemyName().setText(enemyy.getName());
        changeTexts.getEnemyDamageCount().setText(String.valueOf(enemyy.getDamage()));
        changeTexts.getEnemyHPPoints().setText(Integer.toString(enemyy.getHealth()) + "/" + Integer.toString(enemyy.getMaxHealth()));
        return enemyy;
    }

    public Player ChooseBoss( int i, Player human, ChangeTexts changeTexts) {

        changeTexts.getEnemyName().setText("Shao Kahn (босс)");
        enemyy = enemyes[4];
