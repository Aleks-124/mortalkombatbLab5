...
public class JFrames extends javax.swing.JFrame {
    ...
    ResultsOperation result = new ResultsOperation();
    ...
    private void initComponents() {
        ...
        game.change.setEnemyDamageCount(enemyDamageCount);
        game.change.setEnemyDamageLabel(enemyDamageLabel);
        game.change.setEnemyName(enemyName);
        game.change.setEnemyLevel(enemyLevel);
        game.change.setEnemyPicture(enemyPicture);
        game.change.setEnemyHPPoints(enemyHPPoints);
        game.change.setEnemyHPProgressBar(enemyHPProgressBar);
        game.change.setjLabel29(jLabel29);
        game.change.setInformationLabel(informationLabel);
        game.change.setEnemyName(enemyName);
        game.change.setjLabel20(jLabel20);
        ...
        newLevelLabel.setText("Вы перешли на новый уровень. Выберите что улучшить");
        jPanel3.add(newLevelLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 400, 28));
        ...
        inputLocNumber.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        inputLocNumber.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inputLocNumberActionPerformed(evt);
            }
        });
        inputLocationsDialog.getContentPane().add(inputLocNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 170, 30));

        locationsDialogTitle.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        locationsDialogTitle.setText("Выбор кол-ва локаций");
        ...
        confirmCountButton.setText("Старт");
    ...
    private void attackBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_attackBtnActionPerformed
        game.fight.Hit( human, enemy, 1, game.action, result.getResults(), items);
    ...
    private void defendBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_defendBtnActionPerformed
        game.fight.Hit( human, enemy, 0, game.action,result.getResults(), items);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            switch(chooseOptionBox.getSelectedItem().toString()) {
                ...
                locationLable.setText("Локация №"+location.getCurrentLocationsCount());
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            result.EndGameTop(human, jTextField1, jTable1);
    ...
    private void confirmCountButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmCountButtonActionPerformed
       try {
           game.change.setPlayerHPProgressBar(playerHPProgressBar);
           ...
           jFrame1.setVisible(rootPaneCheckingEnabled);
            ...
            human = game.NewHuman();
           location.initLocation(locationsCount);
    ...
    private void weakBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_weakBtnActionPerformed
        game.fight.Hit( human, enemy, 2, game.action, result.getResults(),items);
